...
input.path      <- "/root/palmid/waxsys/waxsys"
...
#### Phylogenetic Tree of PalmDB matches {.tabset}

A UPGMA tree of the top machine hits in PalmDB shows the evolutionary relationships between palmprint sequences. 

##### Phylogeny and Bar Plot for Percentage Aligned to PalmDB for Top Hits

##### Phylogeny and Multiple Sequence Alignment of Top Hits
