...
cbind( palm.sra[, c("run_id", "biosample_id", 'sOTU', 'nickname', 'pident', 'coverage', 'evalue', 'scientific_name')],
       blast.col) %>%
  DT::datatable(
    colnames = c("sra_run", "biosample_id", "sOTU", 'nickname', "input_id%", "coverage", "evalue", "sra_scientific_name", "BLAST"),
